...
public class CarChoose{
    ...
    public static List<Car> getCarByCompany(List<Car> cars){
    ...
    public static List<Car> getCarByYear(List<Car> cars){
        Scanner scanner = new Scanner(System.in);
    ...
    public static List<Car> getCarByPrice(List<Car> cars){
        Scanner scanner = new Scanner(System.in);
